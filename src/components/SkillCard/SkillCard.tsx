...
import { CardTitle, IconImage, LevelBox1, LevelBox2, LevelBox3, LevelBox4, LevelBox5, SkillCardContainer, SkillLevelContainer } from "./SkillCardStyled"
...
export const SkillCard = ({icon}:any)=>{
    ...
    return(
        <SkillCardContainer darkMode={darkMode} colored={icon.color} level={icon.level}>
            <IconImage src={icon.image}/>
            <CardTitle darkMode={darkMode} width={width}>{icon.name} </CardTitle>
            <SkillLevelContainer>
